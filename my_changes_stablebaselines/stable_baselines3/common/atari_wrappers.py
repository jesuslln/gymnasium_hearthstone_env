...
class StickyActionEnv(gymnasium.Wrapper):
    """
    Sticky action.
    ...
    def __init__(self, env: gymnasium.Env, action_repeat_probability: float) -> None:
        super().__init__(env)
...
class WarpFrame(gymnasium.ObservationWrapper):
    ...
    def __init__(self, env: gymnasium.Env, width: int = 84, height: int = 84) -> None:
        super().__init__(env)
        self.width = width
        self.height = height
