...
def unwrap_wrapper(env: gymnasium.Env, wrapper_class: Type[gymnasium.Wrapper]) -> Optional[gym.Wrapper]:
    """
...
def is_wrapped(env: Type[gymnasium.Env], wrapper_class: Type[gymnasium.Wrapper]) -> bool:
    """
...
def make_vec_env(
    env_id: Union[str, Callable[..., gymnasium.Env]],
    n_envs: int = 1,
